$(document).ready(function () {
  var dataTable = $("#table_data").DataTable({
    ...
    pageLength: 10,
    ajax: {
      url: site_url + "/confirm_case/fetch_confirm_case",
      data: {
...
crud.ajax = {
  del_data: function (id, cb) {
    var url = "/confirm_case/del_confirm_case",
      params = {
        id: id,
      };
  ...
  save: function (items, cb) {
    var url = "/confirm_case/save_confirm_case",
      params = {
        items: items,
      };
  ...
  get_update: function (id, cb) {
    var url = "/confirm_case/get_confirm_case",
      params = {
        id: id,
      };
  ...
  sendToLine: function (sms, id, cb) {
    var url = "/confirm_case/sendtoline",
      params = {
        id: id,
        sms: sms,
      };
...
$(document).on("click", 'button[data-btn="btn_edit"]', function (e) {
  ...
  var id = $(this).data("id");
  $("#action").val("update");
  window.location = site_url + "/confirm_case/add_confirm_case/" + id;
});
...
$(document).on("click", 'button[data-btn="btn_files"]', function (e) {
  ...
  window.location = site_url + "/confirm_case/files/" + id + "/" + cid;
});
