$(document).ready(function () {
    var dataTable = $('#table_data').DataTable({
        ...
        "pageLength": 50,
        "ajax": {
            url: site_url + '/admin_risk_type/fetch_admin_risk_type',
            data: {
...
crud.ajax = {
    del_data: function (id, cb) {
        var url = '/admin_risk_type/del_admin_risk_type',
            params = {
                id: id
            }
        ...
        var url = '/admin_risk_type/save_admin_risk_type',
            params = {
                items: items
            }
        ...
        var url = '/admin_risk_type/get_admin_risk_type',
            params = {
                id: id
            }
...
function validate(items) {
     ...
     if (!items.name) {
        swal("กรุณาระบุประเภทความเสี่ยง");
        $("#name").focus();
    }
    else {
        return true;
