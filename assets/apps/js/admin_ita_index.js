$(document).ready(function () {
    var dataTable = $('#table_data').DataTable({
        ...
        "pageLength": 50,
        "ajax": {
            url: site_url + '/admin_ita_index/fetch_admin_ita_index',
            data: {
...
crud.ajax = {
    del_data: function (id, cb) {
        var url = '/admin_ita_index/del_admin_ita_index',
            params = {
                id: id
            }
        ...
        var url = '/admin_ita_index/save_admin_ita_index',
            params = {
                items: items
            }
        ...
        var url = '/admin_ita_index/get_admin_ita_index',
            params = {
                id: id
            }
