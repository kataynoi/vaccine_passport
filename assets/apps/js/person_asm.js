$(document).ready(function () {
  var dataTable = $("#table_data").DataTable({
    ...
    pageLength: 10,
    ajax: {
      url: site_url + "/person_asm/fetch_person_vaccine",
      data: {
...
crud.ajax = {
  del_data: function (id, cb) {
    var url = "/person_asm/del_person_vaccine",
      params = {
        id: id,
      };
  ...
  save: function (items, cb) {
    var url = "/person_asm/save_person_vaccine",
      params = {
        items: items,
      };
  ...
  get_update: function (id, cb) {
    var url = "/person_asm/get_person_vaccine",
      params = {
        id: id,
      };
  ...
  set_vaccine_status: function (cid, cb) {
    var url = "/person_asm/set_vaccine_status",
      params = {
        cid: cid
      };
  ...
  set_vaccine_status_cancle: function (cid, cb) {
    var url = "/person_asm/set_vaccine_status_cancle",
      params = {
        cid: cid
      };
...
$(document).on("click", "button[data-btn='btn_needle3_cancle']", function (e) {
  ...
  swal({
    title: "คำเตือน?",
    text: "คุณต้องยกเลิกเป้าหมาย การรับวัคซีนเข็ม 3 ",
    icon: "warning",
    buttons: ["cancel !", "Yes !"],
    dangerMode: true,
  }).then(function (isConfirm) {
