$(document).ready(function() {
    var dataTable = $('#table_data').DataTable({
        ...
        "pageLength": 50,
        "ajax": {
            url: site_url + '/admin_employee_type/fetch_admin_employee_type',
            data: {
...
crud .ajax = {
    del_data:function (id,cb){
        var url = '/admin_employee_type/del_admin_employee_type',
            params = {
                id: id
            }
        ...
        app.ajax(url, params, function (err, data) {
            err ? cb(err) : cb(null, data);
             ...
             var url = '/admin_employee_type/save_admin_employee_type',
                 params = {
                     items: items
                 }
             ...
             app.ajax(url, params, function (err, data) {
                 err ? cb(err) : cb(null, data);
                   ...
                   var url = '/admin_employee_type/get_admin_employee_type',
                       params = {
                           id: id
                       }
...
function validate(items){
    ...
    if (!items.id) { swal("กรุณาระบุ");$("#id").focus();}else if (!items.name) { swal("กรุณาระบุ");$("#name").focus();}
    else{
        return true;
    }
